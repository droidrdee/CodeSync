...
function mergeDriver(workspaceFolder: vscode.WorkspaceFolder){
    try {
        const codesyncFolderPath = path.join(workspaceFolder.uri.fsPath, GAIT_FOLDER_NAME);        // Define the custom merge driver script content
 ...
 */
 function createCodesyncFolderIfNotExists(workspaceFolder: vscode.WorkspaceFolder) {
...
export function initializeCodesync() {
